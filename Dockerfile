...
ARG TARGETPLATFORM
RUN if [ "$TARGETPLATFORM" = "linux/amd64" ]; then ENV ARCHITECTURE=amd64; elif [ "$TARGETPLATFORM" = "linux/arm/v7" ]; then ENV ARCHITECTURE=arm; elif [ "$TARGETPLATFORM" = "linux/arm64" ]; then ENV ARCHITECTURE=aarch64; else ENV ARCHITECTURE=amd64; fi
